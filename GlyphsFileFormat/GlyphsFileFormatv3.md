...
- <code><strong>anchor</strong>: object</code><a name="spec-glyphs-3-anchor"></a> – (`GSAnchor`)
    - <code><strong>attr</strong>: object = {}</code> <img alt="new" src="https://img.shields.io/badge/new-1c6d37" align="center"> – The attributes of the anchor. Starting in version 4, this also holds the user data; before that, `userData` is a key of its own. See [`attr`](#spec-glyphs-3-attr).
