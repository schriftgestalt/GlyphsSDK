...
class Window(VanillaBaseObject):
    def __init__(self, posSize: Size, title: str = "", minSize: Optional[Tuple[int, int]] = None, maxSize: Optional[Tuple[int, int]] = None, textured: bool = False, autosaveName: Optional[str] = None, closable: bool = True, miniaturizable: bool = True, initiallyVisible: bool = True, fullScreenMode=None, titleVisible: bool = True, fullSizeContentView: bool = False, screen: Optional[NSScreen] = None): ...
    def open(self) -> None: ...
    def show(self) -> None: ...
    def close(self) -> None: ...
...
class HUDFloatingWindow(Window):
	...
...
class ScrollView(VanillaBaseObject):
    def __init__(self, posSize: PosSize, documentView: Any, backgroundColor: Optional[Any] = None, hasHorizontalScroller: bool = True, hasVerticalScroller: bool = True, autohidesScrollers: bool = True): ...
...
class Button(VanillaBaseControl):
    def __init__(self, posSize: PosSize, title: str, callback: Optional[Callable[..., Any]] = None, style: str = "rounded", sizeStyle: str = "regular"): ...
    def get(self) -> str: ...
...
class EditText(VanillaBaseControl):
    def __init__(self, posSize: PosSize, text: str | int = "", callback: Optional[Callable[..., Any]] = None, continuous: bool = True, readOnly: bool = False, formatter: Optional[NSFormatter] = None, placeholder: Optional[str] = None, sizeStyle: str = "regular"): ...
    def get(self) -> str: ...
    def set(self, text: str | int | float) -> None: ...
    def _setCallback(self, Any) -> None: ...

class CheckBox(Button):
    def __init__(self, posSize: PosSize, title: str, callback: Optional[Callable[..., Any]] = None, value: bool = False, sizeStyle: str = "regular"): ...
    def get(self) -> bool: ...
    def set(self, value: bool) -> None: ...

class RadioGroup(VanillaBaseControl):
    def __init__(self, posSize: PosSize, titles: list[str], isVertical: bool = True, callback: Optional[Callable[..., Any]] = None, sizeStyle: str = "regular"): ...
    def get(self) -> int: ...
    def set(self, value: int) -> None: ...

class PopUpButton(VanillaBaseControl):
    def __init__(self, posSize: PosSize, items: Sequence[str], callback: Optional[Callable[..., Any]] = None, sizeStyle: str = "regular", bordered: bool = True): ...
    def get(self) -> int: ...
    def set(self, value: int) -> None: ...
...
class ComboBox(VanillaBaseControl):
    def __init__(self, posSize: PosSize, items: Sequence[str | int | float], completes: bool = True, callback: Optional[Callable[..., Any]] = None, continuous: bool = True, sizeStyle: str = "regular"): ...
    def get(self) -> str: ...
...
class SegmentedButton(VanillaBaseControl):
    def __init__(self, posSize: PosSize, segmentDescriptions: list[dict], callback: Optional[Callable[..., Any]] = None, selectionStyle: str = "one", sizeStyle: str = "small"): ...

class Slider(VanillaBaseControl):
    def __init__(self, posSize: PosSize, minValue: float = 0.0, maxValue: float = 100.0, value: float = 50.0, callback: Optional[Callable[..., Any]] = None, tickMarkCount: Optional[float] = None, stopOnTickMarks: bool = False, continuous: bool = True, sizeStyle: str = "regular", tickMarks: Optional[int] = None): ...
    def get(self) -> float: ...
...
class List(VanillaBaseObject):
    def __init__(
        ...
        columnDescriptions: Optional[list[dict]] = None,
        showColumnTitles: bool = True,
        selectionCallback: Optional[Callable[..., Any]] = None,
        doubleClickCallback: Optional[Callable[..., Any]] = None,
        editCallback: Optional[Callable[..., Any]] = None,
        menuCallback: Optional[Callable[..., Any]] = None,
        ...
        selfDropSettings: Optional[Any] = None,
        selfWindowDropSettings: Optional[Any] = None,
        selfDocumentDropSettings: Optional[Any] = None,
        selfApplicationDropSettings: Optional[Any] = None,
        otherApplicationDropSettings: Optional[Any] = None,
        dragSettings: Optional[Any] = None,
...
class Box(VanillaBaseObject):
    def __init__(self, posSize: PosSize, title: str = "", fillColor: Optional[NSColor] = None, borderColor: Optional[NSColor] = None, borderWidth: Optional[float] = None, cornerRadius: Optional[float] = None, margins: Optional[float] = None): ...
...
class ColorWell(VanillaBaseObject):
    def __init__(self, posSize: PosSize, color: Optional[Any] = None, callback: Optional[Callable[..., Any]] = None): ...
    def get(self) -> Any: ...  # Returns an NSColor object
    def set(self, color: Any) -> None: ...

class ImageView(VanillaBaseObject):
    def __init__(self, posSize: PosSize, horizontalAlignment: str = "center", verticalAlignment: str = "center", scale: str = "proportional", imageObject: Optional[Any] = None): ...
    def setImage(self, imageObject: Optional[Any] = None, imagePath: Optional[str] = None, imageNamed: Optional[str] = None) -> None: ...
    def getImage(self) -> Any: ...

class LevelIndicator(VanillaBaseObject):
    def __init__(self, posSize: PosSize, minValue: int = 0, maxValue: int = 100, value: int = 0, warningValue: Optional[int] = None, criticalValue: Optional[int] = None, style: str = "relevancy", sizeStyle: str = "regular"): ...
    def get(self) -> int: ...
    def set(self, value: int) -> None: ...
...
class Tabs(VanillaBaseObject):
    def __init__(self, posSize: PosSize, tabLabels: list[str], callback: Optional[Callable[..., Any]] = None, sizeStyle: str = "regular"): ...
    def get(self) -> int: ...
...
class TextEditor(VanillaBaseObject):
    def __init__(self, posSize: PosSize, text: str = "", callback: Optional[Callable[..., Any]] = None, readOnly: bool = False, checksSpelling: bool = False): ...
